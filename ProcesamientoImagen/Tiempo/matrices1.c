/*
Este programa muestra la diferencia de tiempo al recorrer una matriz
por filas y por columnas.
La función sumaMatrices recorre por fila y la función sumaMatrices2 
por columna
*/
#include <stdio.h>
#include <stdint.h>
...
void sumaMatrices2( int *A, int *B, int *C );
